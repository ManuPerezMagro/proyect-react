...
const products = [
    { name:"ASUS NVIDIA GEFORCE GTX 1650 OC PHOENIX 4GB DDR5", img:"../../public/img/nvidea-geforce-gtx-1650.png",category:"grafica",description:`-Motor gráfico:  NVIDIA® GeForce GTX 1650
    -Bus: PCI Express 3.0
    -OpenGL®4.6: Sí
    -Memoria de video: DDR5 de 4 GB
    -Reloj del motor: Modo OC - 1710 MHz
    -Núcleo CUDA: 896
    -Velocidad de memoria: 8002 Mhz
    -interfaz de memoria: 128 bits
    -Resolución máxima digital: 7680 x 4320
    -Interfaz:
    Sí x 1 (DVI-D nativo)
    Sí x 1 (HDMI nativo 2.0b)
    Sí x 1 (DisplatPort 1.4 nativo)
    -Compatibilidad con HDCP Sí (2.2)
    -Soporte de pantalla máximo: 3
    -Soporte NVlink / Crossfire: No
    -Dimensiones: 19 x 11 x3.8 Cm
    -PSU recomendada: 300W
    -Espacio: 2 ranuras`, price:"218999", stock:"4"},
    {name:"ASUS ROG STRIX NVIDIA GEFORCE RTX 4070TI 12GB GAMING GDDR6X", img:"../../public/img/nvidea-geforce-rtx-4070ti.png",category:"grafica", description:`-Motor Gráfico: NVIDIA® GeForce RTXTM 4070 Ti
    -Bús: PCI Express 4.0
    -OpenGL: OpenGL® 4.6
    ...
    {name:"ASUS NVIDIA GEFORCE GTX 1660 SUPER TUF GAMING OC 6GB DUAL", img:"../../public/img/nvidea-geforce-gtx-1660super.png",category:"grafica", description:`-Motor gráfico: NVIDIA® GeForce® GTX 1660 SUPER™
    -Bús: PCI Express 3.0
    -OpenGL: OpenGL®4.6
    ...
    {name:"GIGABYTE NVIDIA GEFORCE RTX 4080 EAGLE 16GB GDDR6X", img:"../../public/img/nvidea-geforce-rtx-4080.png",category:"grafica",description:`-Procesamiento de gráficos: GeForce RTX™ 4080
    ...
    {name:"POWERCOLOR RX550 LOW PROFILE 4GB GDDR5", img:"../../public/img/powercolor-rx550.png",category:"grafica",description:`Motor gráfico: AXRX 550 4GBD5-HLE
    ...
    {name:"MONITOR 19 PHILIPS 193V5LHSB2/55 HDMI HD 60HZ", img:"../../public/img/monitor-philips-19.jpg",category:"monitores", description:`LCD TFT
    ...
    {name:"MONITOR 20 LED LG 20MK400H-B HDMI HD", img:"../../public/img/monitor-lg-20.jpg",category:"monitores", description:`-Tamaño (Pulgada) 19.5" / 49.4cm 
    -Tipo panel TN 
    ...
    {name:"MONITOR 27 NOBLEX 91MK27X7100 VA FHD 75HZ", img:"../../public/img/monitor-noblex-27.jpg",category:"monitores", description:`-Pantalla: 450x613x255mm
    ...
    {name:"MOUSE GENIUS DX 120 USB 1000 DPI", img:"../../public/img/mouse-genius-dx120.jpg",category:"mouse", description:`Interfaz USB
    ...
    { name:"MOUSE INALAMBRICO REDRAGON M690 MIRACLE", img:"../../public/img/mouse-redragon-m690.png",category:"mouse", description:`-Tipo: inalámbrico de 2,4 Ghz
    -Voltaje: 1,5 V
    -Corriente: 15 mA
    -USB: USB 2.0 y 3.0
    ...
    { name:"MOUSE LOGITECH G300S GAMING OPTICAL", img:"../../public/img/mouse-logitech-g300s.jpg",category:"mouse", description:`ESPECIFICACIONES FÍSICAS
    Altura: 115 mm
    Anchura: 72 mm
    Profundidad: 37 mm
    ...
    { name:"MOUSE REDRAGON M808 STORM PRO", img:"../../public/img/mouse-redragon-m808.jpg",category:"mouse", description:`Botones Programables: 8
    ...
    { name:"MOUSE LOGITECH G G502X WHITE", img:"../../public/img/mouse-logitech-g502x.png",category:"mouse", description:`-Dimensiones:
    Altura: 131,4 mm
    Ancho: 41,1 mm
    Profundidad: 79,2 mm
    -Sensor: HERO 25K
    ...
    { name:"TECLADO HDC KB113 USB", img:"../../public/img/teclado-hdc.jpg",category:"teclado", description:`TECLAS: 113
    DISEÑO: español
    TECLAS MULTIMEDIA: 9
    VIDA DE TECLAS: 10 millones de veces`, price:"7890", stock:"12"},
    { name:"TECLADO PHILIPS G401 MIXED LED MECANICO", img:"../../public/img/teclado-philips-g401.png",category:"teclado", description:`* Teclado mecanico Philips G401
    ...
    * Dimensiones (Largo x Profundo x Alto)
    ...
    { name:"TECLADO REDRAGON MITRA K551 RGB MECANICO ESP", img:"../../public/img/telcado-redragon-k551.png",category:"teclado", description:`Iluminación RGB
    ...
    { name:"TECLADO LOGITECH G G213 RETROILUMINADO MULTIMEDIA", img:"../../public/img/teclado-logitech-g213.png",category:"teclado", description:`FUNCIONES
    ...
    *Sometido a pruebas con derrames de 60 ml de líquido
    ...
    { name:"AURICULAR REDRAGON H120 ARES C/MICROFONO S/ADAPTADOR", img:"../../public/img/auris-redragon-h120.jpg",category:"auriculares", description:` Tipo de salida: Stereo
    ...
    {name:"AURICULAR REDRAGON LAMIA 2 RGB 7.1", img:"../../public/img/auris-redragon-lamia2.png",category:"auriculares", description:`Sonido envolvente virtual de 7.1 canales
    ...
    { name:"AURICULAR LOGITECH G G335 BLACK", img:"../../public/img/auris-logitech-g335.jpg",category:"auriculares", description:`-Dimensiones
    Longitud: 189 mm
    Anchura: 180 mm
    Profundidad: 79 mm
    ...
    { name:"MICROFONO REDRAGON BLAZAR GM300", img:"../../public/img/microfono-redragon-gm300.png",category:"microfonos", description:`Material: Metal
    ...
    { name:"MICROFONO HYPERX QUADCAST S PC PS4", img:"../../public/img/microfono-hyperx-quadcast.jpg",category:"microfonos", description:`-Consumo de energía: 5 V 220 mA (luz blanca)
